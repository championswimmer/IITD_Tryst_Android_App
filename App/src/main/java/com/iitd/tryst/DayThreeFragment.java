 ...
 * {@link com.iitd.tryst.DayThreeFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link com.iitd.tryst.DayThreeFragment#newInstance} factory method to
...
public class DayThreeFragment extends Fragment {
    ...
    public static DayThreeFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        for (int i =0, j=0; i < eventNames.length; i++) {
            if (eventDates[i].equalsIgnoreCase("28")) {
